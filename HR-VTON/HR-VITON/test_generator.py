...
def get_opt():
    ...
    parser.add_argument("--data_list", default="pairs1.txt")
    ...
    parser.add_argument('--tensorboard_dir', type=str, default='../kaggle/working/data/tensorboard', help='save tensorboard infos')
