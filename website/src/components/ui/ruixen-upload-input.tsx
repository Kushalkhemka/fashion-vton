...
// Remove next/image import for non-Next.js projects
...
export default function RuixenUploadInput({ onFileSelect }: { onFileSelect: (file: File) => void }) {
    ...
    <div className="w-full max-w-md mx-auto px-6">
      ...
      >
        ...
        <div className="relative flex items-center justify-center bg-zinc-100 dark:bg-zinc-800">
          {preview ? (
            <>
              {/* Use img instead of next/image for non-Next.js */}
              <img
                src={preview}
                alt="Preview"
