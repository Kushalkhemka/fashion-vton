...
# Simple VectorQuantizer replacement
class VectorQuantizer(torch.nn.Module):
    def __init__(self, n_embed, embed_dim, beta=0.25, remap=None, sane_index_shape=False):
        super().__init__()
    ...
    def forward(self, z):
        ...
        # Distances from z to embeddings e_j (z - e)^2 = z^2 + e^2 - 2 z e
        ...
        loss = torch.mean((z_q.detach() - z_flattened)**2) + self.beta * torch.mean((z_q - z_flattened.detach())**2)
